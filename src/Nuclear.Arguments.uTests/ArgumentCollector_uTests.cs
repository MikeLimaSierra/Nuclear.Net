...
namespace Nuclear.Arguments {
    ...
    class ArgumentCollector_uTests {
        ...
        void Constructors() {
            ...
            Test.If.Value.Equals(argC.SwitchIndicator, '-');
            Test.If.Value.Equals(argC.ValueSeparator, ';');

            Test.Note("new ArgumentCollector('_', '$')");
            Test.IfNot.Action.ThrowsException(() => { argC = new ArgumentCollector('_', '$'); }, out ex);
            Test.If.Value.Equals(argC.SwitchIndicator, '_');
            Test.If.Value.Equals(argC.ValueSeparator, '$');
        ...
        void Collect() {
            ...
            Test.If.Value.Equals(argC.Arguments.Count, 1);

            Test.If.Value.IsTrue(argC.Arguments[0].IsSwitch);
            Test.If.Value.Equals(argC.Arguments[0].SwitchName, "z");
            ...
            Test.If.Value.Equals(argC.Arguments[0].Value, "added_value");

            Test.Note("-n, 42");
            Test.IfNot.Action.ThrowsException(() => { argC.Collect(new String[] { "-n", "42" }); }, out ex);
            Test.If.Value.Equals(argC.Arguments.Count, 2);

            Test.If.Value.IsTrue(argC.Arguments[1].IsSwitch);
            Test.If.Value.Equals(argC.Arguments[1].SwitchName, "n");
            Test.If.Value.IsTrue(argC.Arguments[1].HasValue);
            Test.If.Value.Equals(argC.Arguments[1].Value, "42");

            Test.Note("--force");
            Test.IfNot.Action.ThrowsException(() => { argC.Collect(new String[] { "--force" }); }, out ex);
            Test.If.Value.Equals(argC.Arguments.Count, 3);

            Test.If.Value.IsTrue(argC.Arguments[2].IsSwitch);
            Test.If.Value.Equals(argC.Arguments[2].SwitchName, "force");
            ...
            Test.If.Value.Equals(argC.Arguments[2].Value, "added_value2");
        ...
        void CollectCombined() {
            ...
            Test.Note("all");
            Test.If.Value.IsTrue(argC.Arguments[1].IsSwitch);
            Test.If.Value.Equals(argC.Arguments[1].SwitchName, "all");
            Test.If.Value.IsTrue(argC.Arguments[1].HasValue);
            Test.If.Value.Equals(argC.Arguments[1].Value, "your_base_are_belong_to_us");

            Test.Note("unicorn");
            Test.If.Value.IsFalse(argC.Arguments[2].IsSwitch);
            Test.If.Object.IsNull(argC.Arguments[2].SwitchName);
            Test.If.Value.IsTrue(argC.Arguments[2].HasValue);
            Test.If.Value.Equals(argC.Arguments[2].Value, "unicorn");

            Test.Note("asdf");
            Test.If.Value.IsTrue(argC.Arguments[3].IsSwitch);
            Test.If.Value.Equals(argC.Arguments[3].SwitchName, "asdf");
        ...
        void TryGetSwitch() {
            ...
            Test.If.Value.Equals(arg.Value, "some value of -Z");
        ...
        void GetSeparatedValues() {
            ...
            Test.If.Value.Equals(values.Count, 3);
            Test.If.Value.Equals(values[0], "one");
            Test.If.Value.Equals(values[1], "two");
            Test.If.Value.Equals(values[2], "three");

            arg.Value = "one;;three";
            Test.Note("one;;three");
            Test.IfNot.Action.ThrowsException(() => values = argC.GetSeparatedValues(arg), out ex);
            Test.IfNot.Object.IsNull(values);
            Test.If.Value.Equals(values.Count, 2);
            Test.If.Value.Equals(values[0], "one");
            Test.If.Value.Equals(values[1], "three");

            arg.Value = ";;;";
            Test.Note(";;;");
            Test.IfNot.Action.ThrowsException(() => values = argC.GetSeparatedValues(arg), out ex);
            Test.IfNot.Object.IsNull(values);
            Test.If.Value.Equals(values.Count, 0);

            arg.Value = "just_this_one";
            Test.Note("just_this_one");
            Test.IfNot.Action.ThrowsException(() => values = argC.GetSeparatedValues(arg), out ex);
            Test.IfNot.Object.IsNull(values);
            Test.If.Value.Equals(values.Count, 1);
            Test.If.Value.Equals(values[0], "just_this_one");
