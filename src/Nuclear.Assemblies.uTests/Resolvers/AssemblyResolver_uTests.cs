    ...
    class AssemblyResolver_uTests {
        ...
        IEnumerable<Object[]> VersionsMatch_Data() {
            return new List<Object[]>() {
                ...
                new Object[] { MatchingStrategies.Unknown, new Version(2, 2, 3), new Version(2, 2, 2), false },
                new Object[] { MatchingStrategies.Unknown, new Version(2, 3, 2), new Version(2, 2, 2), false },
                new Object[] { MatchingStrategies.Unknown, new Version(3, 2, 2), new Version(2, 2, 2), false },
                ...
                new Object[] { MatchingStrategies.Unknown, new Version(2, 2, 2), new Version(2, 2, 3), false },
                new Object[] { MatchingStrategies.Unknown, new Version(2, 2, 2), new Version(2, 3, 2), false },
                new Object[] { MatchingStrategies.Unknown, new Version(2, 2, 2), new Version(3, 2, 2), false },
                ...
                new Object[] { MatchingStrategies.Strict, new Version(2, 2, 3), new Version(2, 2, 2), false },
                new Object[] { MatchingStrategies.Strict, new Version(2, 3, 2), new Version(2, 2, 2), false },
                new Object[] { MatchingStrategies.Strict, new Version(3, 2, 2), new Version(2, 2, 2), false },
                ...
                new Object[] { MatchingStrategies.Strict, new Version(2, 2, 2), new Version(2, 2, 3), false },
                new Object[] { MatchingStrategies.Strict, new Version(2, 2, 2), new Version(2, 3, 2), false },
                new Object[] { MatchingStrategies.Strict, new Version(2, 2, 2), new Version(3, 2, 2), false },
                ...
                new Object[] { MatchingStrategies.SemVer, new Version(2, 2, 3), new Version(2, 2, 2), true },
                new Object[] { MatchingStrategies.SemVer, new Version(2, 3, 2), new Version(2, 2, 2), false },
                new Object[] { MatchingStrategies.SemVer, new Version(3, 2, 2), new Version(2, 2, 2), false },
                ...
                new Object[] { MatchingStrategies.SemVer, new Version(2, 2, 2), new Version(2, 2, 3), true },
                new Object[] { MatchingStrategies.SemVer, new Version(2, 2, 2), new Version(2, 3, 2), true },
                new Object[] { MatchingStrategies.SemVer, new Version(2, 2, 2), new Version(3, 2, 2), false },
            };
        }
