...
namespace Nuclear.Assemblies.Resolvers {
    ...
    public interface IAssemblyResolver {
        ...
        Boolean TryResolve(ResolveEventArgs e, out FileInfo file);
        ...
        /// <param name="file">The resolved file.</param>
        /// <returns>True if a file could be found.</returns>
        Boolean TryResolve(String fullName, out FileInfo file);
        ...
        /// <param name="file">The resolved file.</param>
        /// <returns>True if a file could be found.</returns>
        Boolean TryResolve(AssemblyName assemblyName, out FileInfo file);
