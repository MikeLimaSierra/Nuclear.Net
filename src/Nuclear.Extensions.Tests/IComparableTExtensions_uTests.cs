...
namespace Nuclear.Extensions {
    class IComparableTExtensions_uTests {
        ...
        void IsEqualThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as DummyIComparableT).IsEqual(0), out ArgumentNullException ex1);
        ...
        void LessThanThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as DummyIComparableT).LessThan(0), out ArgumentNullException ex1);
        ...
        void LessThanOrEqualsThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as DummyIComparableT).LessThanOrEquals(0), out ArgumentNullException ex1);
        ...
        void GreaterThanThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as DummyIComparableT).GreaterThan(0), out ArgumentNullException ex1);
        ...
        void GreaterThanOrEqualsThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as DummyIComparableT).GreaterThanOrEquals(0), out ArgumentNullException ex1);
