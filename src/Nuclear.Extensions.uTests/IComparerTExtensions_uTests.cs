...
namespace Nuclear.Extensions {
    class IComparerTExtensions_uTests {
        ...
        void LessThanThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as IComparer<Dummy>).LessThan(0, 0), out ArgumentNullException ex1);
            Test.If.Action.ThrowsException(() => DynamicComparer.FromDelegate<Dummy>((x, y) => throw new NotImplementedException()).LessThan(0, 0), out NotImplementedException ex2);
        ...
        void LessThanOrEqualsThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as IComparer<Dummy>).LessThanOrEquals(0, 0), out ArgumentNullException ex1);
            Test.If.Action.ThrowsException(() => DynamicComparer.FromDelegate<Dummy>((x, y) => throw new NotImplementedException()).LessThanOrEquals(0, 0), out NotImplementedException ex2);
        ...
        void GreaterThanThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as IComparer<Dummy>).GreaterThan(0, 0), out ArgumentNullException ex1);
            Test.If.Action.ThrowsException(() => DynamicComparer.FromDelegate<Dummy>((x, y) => throw new NotImplementedException()).GreaterThan(0, 0), out NotImplementedException ex2);
        ...
        void GreaterThanOrEqualsThrows() {
            ...
            Test.If.Action.ThrowsException(() => (null as IComparer<Dummy>).GreaterThanOrEquals(0, 0), out ArgumentNullException ex1);
            Test.If.Action.ThrowsException(() => DynamicComparer.FromDelegate<Dummy>((x, y) => throw new NotImplementedException()).GreaterThanOrEquals(0, 0), out NotImplementedException ex2);
