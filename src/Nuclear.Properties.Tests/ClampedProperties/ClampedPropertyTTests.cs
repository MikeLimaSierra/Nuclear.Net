...
namespace Nuclear.Properties.ClampedProperties {
    class ClampedPropertyTTests {

        [TestMethod]
        void TestImplementation() {

#pragma warning disable IDE0022 // Use expression body for methods
            Test.If.TypeImplements<ClampedPropertyT<Int32>, IClampedPropertyT<Int32>>();
#pragma warning restore IDE0022 // Use expression body for methods
        ...
        void TestConstructorNullable() {
            ...
            Test.If.ThrowsException(() => prop = new ClampedPropertyT<Version>(null, new Version(1, 1), new Version(1, 3)), out ArgumentNullException argEx);
        ...
        void DDTestConstructor<TValue>((TValue value, TValue min, TValue max) input, (TValue value, TValue min, TValue max) expected,
            ...
            Test.IfNot.ThrowsException(() => prop = new ClampedPropertyT<TValue>(input.value, input.min, input.max), out Exception ex, _file, _method);
