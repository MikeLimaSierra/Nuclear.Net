...
#pragma warning restore IDE0022 // Use expression body for methods
        ...
        void TestConstructors() {
            ...
            Test.IfNot.ThrowsException(() => e = new TrackedPropertyChangedEventArgs<Object, String>(owner, _old, null), out ex);
            Test.If.ValuesEqual(e.Owner, owner);
            Test.If.ValuesEqual(e.Old, _old);
            Test.If.Null(e.New);
            Test.If.True(e.HasChanged);

            Test.IfNot.ThrowsException(() => e = new TrackedPropertyChangedEventArgs<Object, String>(owner, _old, _new), out ex);
            Test.If.ValuesEqual(e.Owner, owner);
            Test.If.ValuesEqual(e.Old, _old);
            Test.If.ValuesEqual(e.New, _new);
            Test.If.True(e.HasChanged);
