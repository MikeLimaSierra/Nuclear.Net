...
namespace Nuclear.SemVer {
    class SemanticVersion_uTests {
        ...
        [TestMethod]
        [TestData(nameof(VersionCast_Data))]
        void VersionCast(SemanticVersion input, Version expected) {

            Version result = default;

            Test.IfNot.Action.ThrowsException(() => result = (Version) input, out Exception _);

            Test.If.Value.IsEqual(result, expected);

        }

        IEnumerable<Object[]> VersionCast_Data() {
            return new List<Object[]>() {
                new Object[] { null, null },
                new Object[] { new SemanticVersion(1u, 0u, 0u), new Version(1, 0, 0) },
                new Object[] { new SemanticVersion(1u, 2u, 3u), new Version(1, 2, 3) },
                new Object[] { new SemanticVersion(1u, 2u, 3u, preRelease : "beta"), new Version(1, 2, 3) },
                new Object[] { new SemanticVersion(1u, 2u, 3u, metaData: "meta"), new Version(1, 2, 3) },
                new Object[] { new SemanticVersion(1u, 2u, 3u, preRelease: "beta", metaData: "meta"), new Version(1, 2, 3) },
            };
        }

        #endregion

        #region SemanticVersionCast

        [TestMethod]
        [TestData(nameof(SemanticVersionCast_Data))]
        void SemanticVersionCast(Version input, SemanticVersion expected) {

            SemanticVersion result = default;

            Test.IfNot.Action.ThrowsException(() => result = (SemanticVersion) input, out Exception _);

            Test.If.Value.IsEqual(result, expected);

        }

        IEnumerable<Object[]> SemanticVersionCast_Data() {
            return new List<Object[]>() {
                new Object[] { null, null },
                new Object[] { new Version(1, 0, 0), new SemanticVersion(1u, 0u, 0u) },
                new Object[] { new Version(1, 2, 3), new SemanticVersion(1u, 2u, 3u) },
                new Object[] { new Version(1, 2, 3, 4), new SemanticVersion(1u, 2u, 3u) },
            };
        }
        ...
        void EqualsOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {

            Boolean result = default;

            Test.IfNot.Action.ThrowsException(() => result = lhs == rhs, out Exception _);
        ...
        [TestMethod]
        [TestData(nameof(EqualsT_Data))]
        void NotEqualsOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {

            Boolean result = default;

            Test.IfNot.Action.ThrowsException(() => result = lhs != rhs, out Exception _);

            Test.IfNot.Value.IsEqual(result, expected);

        }

        #endregion

        #region IsLessThanOperator

        [TestMethod]
        [TestData(nameof(IsLessThanOperator_Data))]
        void IsLessThanOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {
        ...
        IEnumerable<Object[]> IsLessThanOperator_Data() {
            return new List<Object[]>() {
                new Object[] { new SemanticVersion(0, 0, 0), null, false },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(0, 0, 0), false },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(1, 0, 0), true },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(0, 1, 0), true },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(0, 0, 1), true },
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(0, 0, 0), false },
                new Object[] { new SemanticVersion(0, 1, 0), new SemanticVersion(0, 0, 0), false },
                new Object[] { new SemanticVersion(0, 0, 1), new SemanticVersion(0, 0, 0), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0), true },
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "beta"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "beta"), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha.beta"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.beta"), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha.1"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.1"), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.1"), new SemanticVersion(1, 0, 0, "alpha.2"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.2"), new SemanticVersion(1, 0, 0, "alpha.1"), false },
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(1, 0, 0, null, "meta"), false },
                new Object[] { new SemanticVersion(1, 0, 0, null, "meta"), new SemanticVersion(1, 0, 0), false },
                new Object[] { new SemanticVersion(1, 0, 0, null, "meta"), new SemanticVersion(1, 0, 0, null, "meta.1"), false },
            };
        }

        #endregion

        #region IsGreaterThanOperator

        [TestMethod]
        [TestData(nameof(IsGreaterThanOperator_Data))]
        void IsGreaterThanOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {
        ...
        IEnumerable<Object[]> IsGreaterThanOperator_Data() {
            return new List<Object[]>() {
                new Object[] { new SemanticVersion(0, 0, 0), null, true },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(0, 0, 0), false },
                ...
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(0, 0, 0), true },
                new Object[] { new SemanticVersion(0, 1, 0), new SemanticVersion(0, 0, 0), true },
                new Object[] { new SemanticVersion(0, 0, 1), new SemanticVersion(0, 0, 0), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0), false },
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(1, 0, 0, "alpha"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "beta"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "beta"), new SemanticVersion(1, 0, 0, "alpha"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha.beta"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.beta"), new SemanticVersion(1, 0, 0, "alpha"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha"), new SemanticVersion(1, 0, 0, "alpha.1"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.1"), new SemanticVersion(1, 0, 0, "alpha"), true },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.1"), new SemanticVersion(1, 0, 0, "alpha.2"), false },
                new Object[] { new SemanticVersion(1, 0, 0, "alpha.2"), new SemanticVersion(1, 0, 0, "alpha.1"), true },
                new Object[] { new SemanticVersion(1, 0, 0), new SemanticVersion(1, 0, 0, null, "meta"), false },
                new Object[] { new SemanticVersion(1, 0, 0, null, "meta"), new SemanticVersion(1, 0, 0), false },
                new Object[] { new SemanticVersion(1, 0, 0, null, "meta"), new SemanticVersion(1, 0, 0, null, "meta.1"), false },
            };
        ...
        #region IsLessThanOrEqualOperator

        [TestMethod]
        [TestData(nameof(IsLessThanOrEqualOperator_Data))]
        void IsLessThanOrEqualOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {
        ...
        IEnumerable<Object[]> IsLessThanOrEqualOperator_Data() {
            return new List<Object[]>() {
                new Object[] { new SemanticVersion(0, 0, 0), null, false },
        ...
        #region IsGreaterThanOrEqualOperator

        [TestMethod]
        [TestData(nameof(IsGreaterThanOrEqualOperator_Data))]
        void IsGreaterThanOrEqualOperator(SemanticVersion lhs, SemanticVersion rhs, Boolean expected) {
        ...
        IEnumerable<Object[]> IsGreaterThanOrEqualOperator_Data() {
            return new List<Object[]>() {
                new Object[] { new SemanticVersion(0, 0, 0), null, true },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(0, 0, 0), true },
                new Object[] { new SemanticVersion(0, 0, 0), new SemanticVersion(1, 0, 0), false },
