...
namespace Nuclear.Exceptions {
    ...
    class ExceptionFactoryTests {
        ...
        void TestImplementation() {
            ...
            Test.If.TypeImplements<ExceptionFactory, IExceptionFactory>();

            IExceptionFactory ef1 = ExceptionFactory.Instance;
            IExceptionFactory ef2 = ExceptionFactory.Instance;
